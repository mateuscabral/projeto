                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="carousel-inner">
                                <?php echo $data['nomeprod'];?>
                            </label>
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label">Marca do Modelo</label>
                        <div class="controls">
                            <label class="carousel-inner">
                                <?php echo $data['marcaprod'];?>
                            </label>
                        </div>
                    </div>
