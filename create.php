...
<head>
  ...
  <title>Life Style - Adicionar Cliente</title>
</head>
          ...
          <div class="card">
            ...
            <form class="form-horizontal" action="create.php" method="post">
                ...
                <div class="control-group <?php echo !empty($sexoErro)?'error ': '';?>">
                    ...
                    <div class="controls">
                    <input size="35" class="form-control" name="sexo" type="text" placeholder="Sexo..." required="" value="<?php echo !empty($sexo)?$sexo: '';?>">
                ...
                <div class="form-actions">
                    ...
                    <a href="cadastrocliente.php" type="btn" class="btn btn-default">Voltar</a>
